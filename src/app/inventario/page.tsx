...
export default function InventoryPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Note tone="info" title="Alcance de la V1 en abastecimiento">
        En esta version el abastecimiento se <strong>verifica pero no restringe</strong> el plan de
        produccion: se calcula el consumo de materias primas y se informa la cobertura resultante,
        sin frenar corridas por falta de insumos. La generacion de ordenes de compra automaticas, la
        restriccion dura por disponibilidad de materia prima y la trazabilidad de aprobaciones son{" "}
        <strong>funcionalidad prevista para la V2</strong>.
      </Note>
    </div>
  );
}
